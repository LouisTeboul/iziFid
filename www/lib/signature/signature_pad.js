...
(function (global, factory) {
	...
	SignaturePad.prototype._strokeUpdate = function (event) {
		...
		var coords = this._relMouseCoords(event);
		var x = coords.x;
		var y = coords.y;
	...
	SignaturePad.prototype._relMouseCoords = function (event) {
		...
		if (!event.offsetX) {
			...
			canvasX = (event.pageX * (1 / zoom)) - rect.left;
			canvasY = (event.pageY * (1 / zoom)) - rect.top;
		} else {
			canvasX = event.offsetX * (1 / zoom);
			canvasY = event.offsetY * (1 / zoom);
		}
