...
(function () {
  ...
  angular.module('firebase').factory('$firebaseArray', ["$log", "$firebaseUtils", "$q", function ($log, $firebaseUtils, $q) {
    ...
    FirebaseArray.prototype = {
       ...
       */
      $save: function $save(indexOrItem) {
       ...
       */
      $remove: function $remove(indexOrItem) {
       ...
       * @returns {null|string}
       */
      $keyAt: function $keyAt(indexOrItem) {
       ...
       */
      $indexFor: function $indexFor(key) {
        var self = this;
       ...
       * @returns a promise
       */
      $loaded: function $loaded(resolve, reject) {
       ...
       */
      $watch: function $watch(cb, context) {
       ...
       * @protected
       */
      $$added: function $$added(snap /*, prevChild*/) {
       ...
       * @protected
       */
      $$moved: function $$moved(snap /*, prevChild*/) {
        var rec = this.$getRecord($firebaseUtils.getKey(snap));
        if (angular.isObject(rec)) {
          rec.$priority = snap.getPriority();
          return true;
       ...
       * @protected
       */
      $$process: function $$process(event, rec, prevChild) {
       ...
       * @protected
       */
      $$notify: function $$notify(event, key, prevChild) {
       ...
       * @private
       */
      _addAfter: function _addAfter(rec, prevChild) {
        var i;
        if (prevChild === null) {
          i = 0;
        } else {
       ...
       * @private
       */
      _spliceOut: function _spliceOut(key) {
        var i = this.$indexFor(key);
        if (i > -1) {
       ...
       * @private
       */
      _resolveItem: function _resolveItem(indexOrItem) {
        var list = this.$list;
       ...
       * @private
       */
      _assertNotDestroyed: function _assertNotDestroyed(method) {
        if (this._isDestroyed) {
    ...
    function ArraySyncManager(firebaseArray) {
      ...
      var moved = function moved(snap, prevChild) {
        var rec = firebaseArray.$getRecord($firebaseUtils.getKey(snap));
        if (rec) {
      ...
      var removed = function removed(snap) {
        var rec = firebaseArray.$getRecord($firebaseUtils.getKey(snap));
        if (rec) {
...
(function () {
  ...
  FirebaseAuth.prototype = {
     ...
     */
    authWithCustomToken: function authWithCustomToken(authToken, options) {
     ...
     * @return {Promise<Object>} A promise fulfilled with an object containing authentication data.
     */
    authAnonymously: function authAnonymously(options) {
      var deferred = this._q.defer();
     ...
     * @return {Promise<Object>} A promise fulfilled with an object containing authentication data.
     */
    authWithPassword: function authWithPassword(credentials, options) {
      var deferred = this._q.defer();
     ...
     * @return {Promise<Object>} A promise fulfilled with an object containing authentication data.
     */
    authWithOAuthPopup: function authWithOAuthPopup(provider, options) {
      var deferred = this._q.defer();
     ...
     * @return {Promise<Object>} A promise fulfilled with an object containing authentication data.
     */
    authWithOAuthRedirect: function authWithOAuthRedirect(provider, options) {
      var deferred = this._q.defer();
     ...
     * @return {Promise<Object>} A promise fulfilled with an object containing authentication data.
     */
    authWithOAuthToken: function authWithOAuthToken(provider, credentials, options) {
      var deferred = this._q.defer();
     ...
     */
    onAuth: function onAuth(callback, context) {
      var self = this;
     ...
     */
    _routerMethodOnAuthPromise: function _routerMethodOnAuthPromise(rejectIfAuthDataIsNull) {
      var ref = this._ref,
          utils = this._utils;
     ...
     */
    createUser: function createUser(credentials) {
      var deferred = this._q.defer();
     ...
     */
    changeEmail: function changeEmail(credentials) {
      var deferred = this._q.defer();
     ...
     */
    removeUser: function removeUser(credentials) {
      var deferred = this._q.defer();
...
(function () {
  ...
  angular.module('firebase').factory('$firebaseObject', ['$parse', '$firebaseUtils', '$log', function ($parse, $firebaseUtils, $log) {
    ...
    FirebaseObject.prototype = {
       ...
       */
      $bindTo: function $bindTo(scope, varName) {
        var self = this;
       ...
       * notify().
       */
      $$scopeUpdated: function $$scopeUpdated(newData) {
    ...
    ThreeWayBinding.prototype = {
      assertNotBound: function assertNotBound(varName) {
        if (this.scope) {
      ...
      bindTo: function bindTo(scope, varName) {
        function _bind(self) {
          ...
          var scopeUpdated = function scopeUpdated(newVal) {
            newVal = newVal[0];
            if (!equals(newVal)) {
              sending = true;
              send(newVal);
          ...
          var recUpdated = function recUpdated() {
...
(function () {
  ...
  angular.module('firebase').factory('$firebaseConfig', ["$firebaseArray", "$firebaseObject", "$injector", function ($firebaseArray, $firebaseObject, $injector) {
    ...
    var utils = {
       ...
       * @returns {Function}
       */
      batch: function batch(action, context) {
        return function () {
       ...
       */
      debounce: function debounce(fn, ctx, wait, maxWait) {
      ...
      assertValidRef: function assertValidRef(ref, msg) {
      ...
      // https://developer.mozilla.org/en-US/docs/Web/JavaScript/Reference/Global_Objects/Object/create
      inherit: function inherit(ChildClass, ParentClass, methods) {
      ...
      getPrototypeMethods: function getPrototypeMethods(inst, iterator, context) {
        var methods = {};
      ...
      getPublicMethods: function getPublicMethods(inst, iterator, context) {
      ...
      makeNodeResolver: function makeNodeResolver(deferred) {
      ...
      wait: function wait(fn, _wait) {
        var to = $timeout(fn, _wait || 0);
        return function () {
          if (to) {
            $timeout.cancel(to);
            to = null;
      ...
      trimKeys: function trimKeys(dest, source) {
      ...
      scopeData: function scopeData(dataOrRec) {
        var data = {
          $id: dataOrRec.$id,
      ...
      updateRec: function updateRec(rec, snap) {
        var data = snap.val();
      ...
      applyDefaults: function applyDefaults(rec, defaults) {
      ...
      dataKeys: function dataKeys(obj) {
        var out = [];
       ...
       */
      getKey: function getKey(refOrSnapshot) {
      ...
      doRemove: function doRemove(ref) {
        var def = utils.defer();
...
//# sourceMappingURL=angularfire-compiled.js.map