                ...
                function ($scope, $rootScope, $element, $attrs, $http, $window, $timeout, $log, $mdDialog, $mdToast, $animate, $firebaseObject, APIService) {
                    ...
                    function displayData() {
                        ...
                        APIService.get.loyaltyObject($scope.barcode, function (data) {
                            ...
                            if (data === false) {
                                $scope.reset();
                                navigator.notification.alert('Carte inconnue !', null, "Mr. Pretzels", "OK");
...
//                        }
                    ...
                    $scope.login = function () {
                        ...
                        if (navigator.notification) {
                            $scope.barcodeValid ? displayData() : navigator.notification.alert("Ce n° de carte n'est pas valide !", null, "Mr. Pretzels", "OK");
                        } else {
...
//                            }, 1600);
                    ...
                    $scope.useBalanceToPay = function (val, balance) {
                        ...
                        if (~~balance.Value < ~~val) {
                            if (navigator.notification) {
                                $scope.barcodeValid ? displayData() : navigator.notification.alert('Ce montant est supérieur au total de la cagnotte', null, "Mr. Pretzels", "OK");
                            } else {
