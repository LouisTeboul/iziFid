...
angular.module('APIServiceApp', []).factory('APIService', ['$http', '$log', '$timeout', function ($http, $log, $timeout) {
    ...
    errors = {
        ...
        missingClientUrl: function missingClientUrl() {
        ...
        invalidBarcode: function invalidBarcode(barcode) {
        ...
        addPassage: function addPassage() {
    ...
    methods = {
        set: {
            ...
            clientUrl: function clientUrl(url) {
                vars.clientUrl = url;
            },
        ...
        get: {
            ...
            callableUrl: function callableUrl(params) {
            ...
            serverUrl: function serverUrl(uuid) {
            ...
            loyaltyObject: function loyaltyObject(barcode, func) {
             ...
             * A callback function to which we pass the data */
            loyaltyObjectWithPassword: function loyaltyObjectWithPassword(barcode, password, func) {
                return $timeout(function () {
                    var isBarcodeValid = methods.validate.barcode(barcode),
                        isClientUrlValid = methods.validate.clientUrl();
                    if (isBarcodeValid && isClientUrlValid) {
            ...
            formattedOffers: function formattedOffers(loyaltyObj) {
                ...
                if (offers) {
                    ...
                    for (var i = 0; i < offers.length; i++) {
                        ...
                        //                        }
                        //                    }
                        if (offers[i].isValid) offersTypes.push(offers[i]);
                    }
                }
                return offersTypes;
            },
            ...
            emptyPassageObj: function emptyPassageObj() {
                return {
                    "Login": null,
                    "Password": null,
                    "Key": null,
        ...
        actions: {
            ...
            useOffer: function useOffer(offer_id, offer_barcode) {
            ...
            useVoucherOffer: function useVoucherOffer(offer_class_id) {
                passagePromise = null;
                if (!passagePromise) {
            ...
            useAvoir: function useAvoir(balance_id, amount) {
                var passageObj = methods.get.emptyPassageObj();
            ...
            addPassage: function addPassage(obj) {
                console.log(obj);
            ...
            register: function register(formObj) {
                return $timeout(function () {
            ...
            registerAnonymous: function registerAnonymous(formObj) {
                return $timeout(function () {
        ...
        validate: {
            ...
            barcode: function barcode(_barcode) {
                return !!(+_barcode && ~[8, 10].indexOf(_barcode.toString().length) || new RegExp(/(^[0-9]*$)|(^[_a-z0-9]+(\.[_a-z0-9]+)*@[a-z0-9-]+(\.[a-z0-9-]+)*(\.[a-z]{2,4})$)/));
            }
        }
    };
