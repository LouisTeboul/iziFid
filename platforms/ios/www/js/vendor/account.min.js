...
angular.module('APIServiceApp')
    .directive('iziAccount', function () {
        return {
            ...
            templateUrl: 'js/vendor/views/account.html',
            link: function (scope) {
...
//                    $($('script[type="text/ng-template"]').html()).appendTo('body'); // jshint ignore:line
                    ...
                    $scope.disconnect = function () {
                        $window.confirm("Êtes-vous sûr de vouloir vous déconnecter ?") ? (function() { delete $scope.barcode; delete $rootScope.cardNum; delete $scope.form.barcode; })() : 0;
                    };
                    ...
                    $scope.addPassage = function () {
                        APIService.actions.addPassage(APIService.get.emptyPassageObj()).success(function (data) {
                            $scope.hideDialog();
                            $scope.hideDialog();
                            $timeout(function () {
                                $window.alert('Un passage a bien été ajouté à cette carte');
                            }, 0);
                    ...
                    $rootScope.useBalanceToPay = function (val) {
                        ...
                        APIService.actions.addPassage(passageObj).success(function (data) {
                            ...
                            $scope.hideDialog();
                            $timeout(function () {
                                $window.alert("Le paiement en avoir a bien été effectué");
                            }, 0);
                            delete $scope.barcode;
                            delete $rootScope.cardNum;
                            delete $scope.form.barcode;
                    ...
                    $scope.useOffer = function (offer) {
                        ...
                        APIService.actions.addPassage(passageObj).success(function (data) {
                            ...
                            $scope.hideDialog();
                            $timeout(function () {
                                $window.alert("L'offre a bien été utilisée");
                            }, 0);
                            delete $scope.barcode;
                            delete $rootScope.cardNum;
                            delete $scope.form.barcode;
                        ...
                        $mdDialog.show({
                            ...
                            template: '<md-dialog aria-label="Utiliser Offre"> \
                                ...
                                <div class="md-actions" layout="row"> \
                                 <div class="clearfix">\
                                    <md-button class="md-primary pull-left" ng-click="useOffer(currentOffer)"> \
                                    VALIDER \
                                    </md-button> \
                    ...
                    $scope.showAddPassageConfirm = function (ev) {
                        $mdDialog.show({
                            ...
                            template: '<md-dialog aria-label="Ajouter un Passage"> \
                                ...
                                <div class="md-actions" layout="row"> \
                                 <div class="clearfix">\
                                    <md-button class="md-primary pull-left" ng-click="addPassage()"> \
                                    VALIDER \
                                    </md-button> \
                                    <md-button class="md-primary" ng-click="hideDialog()"> \
                                    ANNULER \
                        ...
                        if (balance.UseToPay === true) {
                            ...
                            $mdDialog.show({
                                ...
                                <md-dialog-content class="sticky-container clearfix"> \
                                    ...
                                    <div class="md-actions" layout="row"> \
                                     <div class="clearfix"> \
                                        <md-button class="md-primary pull-left" ng-disabled="balancePaymentForm.$invalid || balancePaymentForm.$pristine" ng-click="useBalanceToPay(balancePayment.value)"> \
                                        VALIDER \
                                        </md-button> \
