                ...
                function ($scope, $rootScope, $element, $attrs, $http, $window, $timeout, $log, $mdDialog, $mdToast, $animate, $firebaseObject, APIService) {
                    ...
                    function displayData() {
                        ...
                        APIService.get.loyaltyObject($scope.barcode, function (data) {
                            ...
                            if (data === false) {
                                $scope.reset();
                                navigator.notification.alert('Carte inconnue !', null, "Vidici", "OK");
...
//                        }
                    ...
                    $scope.login = function () {
                        ...
                        if (navigator.notification) {
                            $scope.barcodeValid ? displayData() : navigator.notification.alert("Ce n° de carte n'est pas valide !", null, "Vidici", "OK");
                        } else {
